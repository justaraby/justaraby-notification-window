...
class SEED_WNB
{
    ...
    function reset_defaults( )
    {
        if ( isset( $_POST[ 'reset' ] ) ) {
            ...
            add_settings_error( 'general', 'seed_wnb-settings-reset', __( "Settings reset.", 'just-notification-window' ), 'updated' );
        }
    ...
    function option_page( )
    {
        ...
        <?php screen_icon(); ?>
            ...
            <?php endif; ?>
                    ...
                    <input name="submit" type="submit" value="<?php _e( 'Save Changes', 'just-notification-window' ); ?>" class="button-primary"/>
                    <!-- <input id="reset" name="reset" type="submit" value="<?php _e( 'Reset', 'just-notification-window' ); ?>" class="button-secondary"/>   -->
                    </p>
        ...
        <script>
            jQuery(document).ready(function($) {
                $('#reset').click(function(e){
                    if(!confirm('<?php _e( 'All custom settings values be deleted. Are you sure you want to reset?', 'just-notification-window' ); ?>')){
                        e.preventDefault();
                    }
                });
            });
