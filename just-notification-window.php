<?php
/*
Plugin Name: Justaraby Notification Window
Plugin URI: http://justaraby.com/
Description: Global Notification Window for WordPress
Version:  1.0
Text Domain: just-notification-window
Domain Path: /languages
Author: Justaraby
Author URI: http://www.justaraby.com
License: GPLv2
Copyright 2018  John Turner (email : justaraby@gmail.com, github : @justaraby)
*/
...
define( 'SEED_WNB_FILE', 'just-notification-window/just-notification-window.php' ); // Used for settings link.
define( 'SEED_WNB_TEXTDOMAIN', 'just-notification-window' ); // Your textdomain
define( 'SEED_WNB_PLUGIN_NAME', __( 'Justaraby Notification Window', 'seed_wnb' ) ); // Plugin Name shows up on the admin settings screen.
...
function seed_wnb_load_textdomain() {
    load_plugin_textdomain( 'just-notification-window', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
